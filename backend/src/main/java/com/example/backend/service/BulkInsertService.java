...
public class BulkInsertService {
  ...
  /**
   * Bulk insert patient payers using JDBC batch processing for maximum
   * performance
   */
  @Transactional
  public void bulkInsertPatientPayers(List<PatientPayer> patientPayers) {
    if (patientPayers.isEmpty())
      return;
  ...
  /**
   * Bulk insert role permissions using JDBC batch processing for maximum
   * performance
   */
  @Transactional
